...
void				count_room_edges(t_count count, int *edges,
							t_room *rooms, t_lemin *lemin);
...
void				create_rooms(int room_num, t_room *rooms,
									t_lemin *lemin, char **spl_f);
t_room				create_single_room(int id, char *line, t_room *room);
void				create_edges_arr(int *edges, t_lemin *lemin,
									char **spl_f, t_room *rooms);
